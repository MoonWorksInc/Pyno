...
dinosaur_img = pygame.image.load('C:/Program Files (x86)/Moon Works Inc/Pyno Game/assets/dino.png')
cactus_img = pygame.image.load('C:/Program Files (x86)/Moon Works Inc/Pyno Game/assets/cactus.png')
